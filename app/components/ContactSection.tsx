	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				<h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-900">Let&apos;s Build Something Secure and Brilliant </h2>
				<p className="text-sm sm:text-base text-gray-600 mb-6">Looking for a developer who can turn ideas into impact?</p>
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="julia@szostakiewicz.co.uk"
					...
					<a
						href="Julia_Szostakiewicz_CV.pdf"
						target="_blank"
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/juliaszos"
						target="_blank"
					...
					<a
						href="https://linkedin.com/in/julia-szos/"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-600 hover:text-gray-900 transition-colors p-2 hover:bg-gray-100 rounded-lg"
					>
