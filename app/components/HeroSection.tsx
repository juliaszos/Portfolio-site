		...
		<div className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="absolute inset-0 overflow-hidden">
				{[
					...
					{ icon: '⚠︎', delay: '1s', position: 'bottom-32 left-1/3' },
			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="relative inline-block px-4 sm:px-0">
						...
						<h1 className="relative text-5xl sm:text-7xl md:text-8xl lg:text-8xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-800 pb-2">
							Julia Szostakiewicz
						</h1>
					</div>
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-600">Computing [Cybersecurity] Graduate - First Class </h2>
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
							<p className="text-base sm:text-lg text-gray-600 max-w-2xl px-4 sm:px-0">
								Skilled, driven Computing graduate focused on cybersecurity
							</p>
						</div>

						{/* Tech Stack Pills */}
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['Python', 'Linux', 'Node.js', 'Cybersecurity', 'Django'].map((tech) => (
								<span
									key={tech}
